function EndRaceMenu()
{
    ...
    this.draw = function()
    {
        ...
        colorText("You were " + playerPositionText, 110, 200, "red", 100);
        ...
        colorText("Replay", 320, this.replayButtonY + 65, "black", 50);
        ...
        colorText("Menu", 330, this.menuButtonY + 65, "black", 50);
    }
